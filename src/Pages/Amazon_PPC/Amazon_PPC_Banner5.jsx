...
<div className="w-full container mx-auto md:px-6">
  ...
  <div className='mt-20 md:mt-0 right-side w-full md:w-1/3 pt-4 md:ml-6 rounded-2xl'>
    ...
    <div className="left-side mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
      ...
      In many instances, affiliate marketing, which precisely targets the market through a reliable source, is the only method for Amazon PPC agencies to capitalize on growth on e-commerce platforms. AMZ Inventor uses niche influencers to provide quality leads.
      </p>
      <div className='flex mt-2 flex-wrap text-black w-3/4	mb-4 justify-between' >
           <ul>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Organic optimization</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Keyword targeting</li>
            </ul>
            <ul>
            <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Long-term branding results</li>
            <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Positive conversion rates</li>
            </ul>
           </div>
