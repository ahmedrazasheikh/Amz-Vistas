  ...
  <div className="mt-20 md:mt-0 left-side mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
      ...
      <div className='flex mt-2 flex-wrap text-black w-3/4	mb-4 justify-between' >
           <ul>
              ...
              <li   className='mb-2 mr-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Audience profiling</li>
              <li   className='mb-2 mr-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Campaign optimization</li>
            ...
            <ul>
              <li   className='mb-2 ' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Retargeting</li>
              <li   className='mb-2 ' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Social media management</li>
            </ul>
           </div>
