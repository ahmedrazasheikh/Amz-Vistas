      ...
      <div className="w-full container mx-auto md:px-6">
        <div className="flex flex-col md:flex-row justify-between py-6 md:py-24 animation-from-left">
          ...
          <div style={{"marginTop" :"20px"}} className=" md:mt-0 fade-up-element mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
            ...
            The Amazon PPC agency AMZ Inventor keeps firms up-to-date by curbing excessive expenses, reducing competition, and tailoring ads to specific objectives. In order to ensure that our campaigns function at their peak, we design, build, audit, and optimize them as if we were going to get them wrong the first time. Our Amazon PPC agency provides the following:
            </p> 
       <div className='flex flex-wrap text-white w-3/4	mb-4 justify-between' >
           <ul>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Sponsored Display ads</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Sponsored Product ads</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Amazon Demand Side Platform</li>
            </ul>
            

            <ul>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Sponsored Brand ads</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Affiliate Marketing</li>
            </ul>
           </div>
           <Link to={'/Contact-us'} >
