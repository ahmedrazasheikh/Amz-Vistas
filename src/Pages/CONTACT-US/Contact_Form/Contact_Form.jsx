                ...
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div class="mb-4">
                        <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            <p class="elevated-animate-bottom mx-auto mt-4 max-w-3xl text-xl text-gray-600 dark:text-slate-400">In hac habitasse platea
                                dictumst
                            </p>
                        </div>
                    </div>
                    <div class="flex items-stretch justify-center">
                        <div class="grid md:grid-cols-2">
                            <div class="leftCardAnimation h-full pr-6">
                                ...
                                In the ever-evolving realm of e-commerce, mastering the expansive landscape of Amazon demands more than just a presence—it requires a strategic mastery. This is where our agency truly excels. We are dedicated to empowering businesses through a suite of comprehensive Amazon services designed to propel them to unparalleled heights within the dynamic digital marketplace. Our commitment extends beyond mere transactions.
                                </p>
                                <ul class="mb-6 md:mb-0">
                                    <li class="flex">
                                        ...
                                        <div class="ml-4 mb-4">
                                            ...
                                            <p class="text-gray-600 dark:text-slate-400">Austin,TX</p>
                                        </div>
                                    </li>
                                    <li class="flex">
                                        <div style={{ "background": "#FF9903" }} class="flex h-10 w-10 items-center justify-center rounded  text-gray-50">
                                        ...
                                        <div class="ml-4 mb-4">
                                            ...
                                            <p class="text-gray-600 dark:text-slate-400">Mobile: +1 (737) 222 7373</p>
                            ...
                            <div class="rightCardAnimation card h-fit max-w-6xl p-5 md:p-12" id="form">
                                <h2 style={{ "color": "#232F3F" }} class="mb-4 text-2xl font-bold">Ready to Get Started?</h2>
                                <form id="contactForm">
                                    <div class="mb-6">
                                    ...
                                    <div class="text-center">
                                        <button style={{ "background": "#FF9903" }} type="submit" class="w-full  text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                                    </div>
                                </form>
                            </div>
                        </div>
