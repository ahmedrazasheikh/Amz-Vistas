...
<div className="w-full container mx-auto md:px-6">
  ...
  <div className="mt-20 md:mt-0 left-side mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
      ...
      We are one of the virtual assistant agencies that study and monitor Amazon account feedback to aid you in using industry-leading strategies and avoiding mistakes with product placement and listings. There are always momentous changing and detailing made to suit the clients' preferences here at AMZ Inventor.
      </p>
      ...
      <div className='flex mt-2 flex-wrap text-black w-3/4	mb-4 justify-between' >
           <ul>
              ...
              <li   className='mb-2 mr-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Seller & product feedback monitoring</li>
              <li   className='mb-2 mr-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Product review and monitoring</li>
            ...
            <ul>
              <li   className='mb-2 ' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Sequence email reviews</li>
              <li   className='mb-2 ' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2 " aria-hidden="true"></i>Cataloguing defect trends</li>
            </ul>
           </div>
