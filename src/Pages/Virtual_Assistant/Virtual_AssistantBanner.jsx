    ...
    <div style={{ background: '#232F3F' ,  paddingTop : "40px" }} className='main-banner h-auto'>
      ...
      <div className="w-full container mx-auto md:px-6">
        ...
        <div   className=" md:mt-0  mt-11 fade-up-element mb-10 w-full md:w-7/12 px-6 md:px-3 lg:px-6">
            ...
            Our virtual assistant services help Amazon sellers manage their campaigns for scalable growth by directing their efforts and steering their campaigns. Our Virtual Assistant agency, AMZ Inventor, removes the stumbling hurdles and difficulties of Amazon account management, freeing sellers from operational gaps. Our Amazon VA provides:
            </p> 
       <div className='flex flex-wrap text-white w-3/4	mb-4 justify-between' >
           <ul>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Inventory Management</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Pricing Strategy</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Case Management</li>
            </ul>
            

            <ul>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Catalog/Product organization</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Brand Registry</li>
              <li   className='mb-2' ><i  style={{"color" : "#FF9903"}} class="fa fa-check-circle mr-2" aria-hidden="true"></i>Listing Management</li>
            </ul>
           </div>
           <Link to={'/Contact-us'} >
